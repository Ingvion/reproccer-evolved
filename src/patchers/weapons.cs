...
public static class WeaponsPatcher
{
    ...
    private static (List<StaticsData>, List<StaticsData>, List<StaticsData>, List<CrossbowMods>, List<StaticsData>) BuildStaticsMap()
    {
        ...
        List<StaticsData> allMaterials = [
            ...
            new StaticsData{ Id = "mat_draugr",     Kwda = "WeapMaterialDraugr".GetFormKey(),               Items = [ "IngotCorundum".GetFormKey() ],    Perks = [ "AdvancedArmors".GetFormKey() ]                                    },
            new StaticsData{ Id = "mat_draugrh",    Kwda = "WeapMaterialDraugrHoned".GetFormKey(),          Items = [ "IngotCorundum".GetFormKey() ],    Perks = [ "AdvancedArmors".GetFormKey() ]                                    },
