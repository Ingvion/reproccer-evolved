...
public static class ProjectilesPatcher
{
    ...
    private static (List<DataMap>, List<DataMap>, List<DataMap>) BuildStaticsMap()
    {
        ...
        List<DataMap> allMaterials = [
            ...
            new DataMap{Id = "mat_forsworn",   Kwda = GetFormKey("WAF_WeapMaterialForsworn"),       Items = [ GetFormKey("IngotIron") ],        Perks = [ /* to avoid null checking */ ]      },
            ...
            new DataMap{Id = "mat_iron",       Kwda = GetFormKey("WeapMaterialIron"),               Items = [ GetFormKey("IngotIron") ],        Perks = [ /* to avoid null checking */ ]      },
