...
static class Executor
{
    ...
    internal static Lazy<Config.AllSettings> AllSettings = new();
    ...
    private static List<Utils.StaticsMap> BuildStatics() => [
            ...
            new(Id: "ArmorMaterialDaedric",                   Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbd4|KWDA")                  ),
            new(Id: "ArmorMaterialDragonplate",               Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbd5|KWDA")                  ),
            new(Id: "ArmorMaterialDragonscale",               Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbd6|KWDA")                  ),
            new(Id: "ArmorMaterialDwarven",                   Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbd7|KWDA")                  ),
            new(Id: "ArmorMaterialEbony",                     Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbd8|KWDA")                  ),
            new(Id: "ArmorMaterialElven",                     Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbd9|KWDA")                  ),
            new(Id: "ArmorMaterialElvenGilded",               Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbda|KWDA")                  ),
            new(Id: "ArmorMaterialLeather",                   Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbdb|KWDA")                  ),
            new(Id: "ArmorMaterialGlass",                     Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbdc|KWDA")                  ),
            new(Id: "ArmorMaterialHide",                      Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbdd|KWDA")                  ),
            new(Id: "ArmorMaterialScaled",                    Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbde|KWDA")                  ),
            new(Id: "ArmorMaterialStudded",                   Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbdf|KWDA")                  ),
            new(Id: "ArmorMaterialImperialLight",             Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbe0|KWDA")                  ),
            new(Id: "ArmorMaterialImperialStudded",           Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbe1|KWDA")                  ),
            new(Id: "ArmorMaterialImperialHeavy",             Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbe2|KWDA")                  ),
            new(Id: "ArmorMaterialIron",                      Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbe3|KWDA")                  ),
            new(Id: "ArmorMaterialIronBanded",                Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbe4|KWDA")                  ),
            new(Id: "ArmorMaterialOrcish",                    Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbe5|KWDA")                  ),
            new(Id: "ArmorMaterialSteel",                     Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbe6|KWDA")                  ),
            new(Id: "ArmorMaterialSteelPlate",                Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006bbe7|KWDA")                  ),
            ...
            new(Id: "ArmorSlotCuirass",                       Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006c0ec|KWDA")                  ),
            new(Id: "ArmorSlotBoots",                         Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006c0ed|KWDA")                  ),
            new(Id: "ArmorSlotHelmet",                        Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006c0ee|KWDA")                  ),
            new(Id: "ArmorSlotGauntlets",                     Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0006c0ef|KWDA")                  ),
            ...
            new(Id: "ArmorMaterialNightingale",               Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0010fd61|KWDA")                  ),
            new(Id: "ArmorMaterialDarkBrotherhood",           Formkey: Utils.Helpers.ParseFormKey("Skyrim.esm|0010fd62|KWDA")                  ),
            new(Id: "ArmorMaterialBlades",                    Formkey: Utils.Helpers.ParseFormKey("Update.esm|000009c0|KWDA")                  ),
            new(Id: "ArmorMaterialForsworn",                  Formkey: Utils.Helpers.ParseFormKey("Update.esm|000009b9|KWDA")                  ),
            new(Id: "ArmorMaterialThievesGuild",              Formkey: Utils.Helpers.ParseFormKey("Update.esm|000009bc|KWDA")                  ),
            new(Id: "ArmorMaterialBearStormcloak",            Formkey: Utils.Helpers.ParseFormKey("Update.esm|000009be|KWDA")                  ),
            new(Id: "WAF_WeapMaterialBlades",                 Formkey: Utils.Helpers.ParseFormKey("Update.esm|00af0103|KWDA")                  ),
            new(Id: "WAF_WeapMaterialForsworn",               Formkey: Utils.Helpers.ParseFormKey("Update.esm|00af0104|KWDA")                  ),
            new(Id: "WAF_ArmorWolf",                          Formkey: Utils.Helpers.ParseFormKey("Update.esm|00af0107|KWDA")                  ),
            new(Id: "WAF_ArmorMaterialGuard",                 Formkey: Utils.Helpers.ParseFormKey("Update.esm|00af0112|KWDA")                  ),
            new(Id: "WAF_DLC1WeapMaterialDawnguard",          Formkey: Utils.Helpers.ParseFormKey("Update.esm|00af0116|KWDA")                  ),
            new(Id: "WAF_DLC1ArmorDawnguardHeavy",            Formkey: Utils.Helpers.ParseFormKey("Update.esm|00af0117|KWDA")                  ),
            new(Id: "WAF_DLC1ArmorDawnguardLight",            Formkey: Utils.Helpers.ParseFormKey("Update.esm|00af0118|KWDA")                  ),
            new(Id: "WAF_ArmorMaterialDraugr",                Formkey: Utils.Helpers.ParseFormKey("Update.esm|00af0135|KWDA")                  ),
            new(Id: "WAF_ArmorMaterialThalmor",               Formkey: Utils.Helpers.ParseFormKey("Update.esm|00af0222|KWDA")                  ),
            ...
            new(Id: "MasqueradeBandit",                       Formkey: Utils.Helpers.ParseFormKey("Skyrim AE Redone - Core.esm|00000f44|KWDA") ),
            new(Id: "MasqueradeForsworn",                     Formkey: Utils.Helpers.ParseFormKey("Skyrim AE Redone - Core.esm|00000f45|KWDA") ),
            new(Id: "MasqueradeImperial",                     Formkey: Utils.Helpers.ParseFormKey("Skyrim AE Redone - Core.esm|00000f46|KWDA") ),
            new(Id: "MasqueradeStormcloak",                   Formkey: Utils.Helpers.ParseFormKey("Skyrim AE Redone - Core.esm|00000f47|KWDA") ),
            new(Id: "MasqueradeThalmor",                      Formkey: Utils.Helpers.ParseFormKey("Skyrim AE Redone - Core.esm|00000f48|KWDA") ),
